...
abstract class CMB2_Field_Group {
	...
	public function process_fields() {
		...
		foreach ( $this->fields_array as $field_args ) {
	 ...
	 * @return object|null
	 */
	public function add_group( $field, $position = 0 ) {

		$field_id = $this->add_field( $field, $position );

		$new_group = $this->add_group_field( $field, $field, $position );


		$field_obj = $this->get_field( $field_id );
