...
class CMB_Customize_Checkbox extends WP_Customize_Control {
    ...
    public function render_content() {
       ...
       $field = new CMB2_Field( array( 'object_id' => $this->id, 'object_type' => 'checkbox', 'field_args' => array( 'id' => $this->id, 'type' => 'checkbox', 'name' => $this->id, 'value' => $this->value(), 'desc' => $this->label, 'escaped_value' => esc_html( $this->value() ) ) ) );
