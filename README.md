...
* [CMB2 Field Type: Typography](https://github.com/eduplessis/cmb2-typography) by [eduplessis](https://github.com/eduplessis): This plugin adds a CMB2 Typography field type for selecting font, alignment, font-size, color, etc.
