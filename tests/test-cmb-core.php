			...
			<div class="cmb-td">
				<div data-groupid="group_field" id="group_field_repeat" class="cmb-nested cmb-field-list cmb-repeatable-group non-sortable repeatable" style="width:100%;">
					...
					<div class="postbox cmb-row cmb-repeatable-grouping closed" data-iterator="0">
						<button type="button" data-selector="group_field_repeat" data-confirm="Are you sure you want to remove it?" class="dashicons-before dashicons-no-alt cmb-remove-group-row" title="Remove Group"></button>
						...
						<div class="inside cmb-td cmb-nested cmb-field-list">
							...
							<div class="cmb-row cmb-remove-field-row">
								<div class="cmb-remove-row">
									<button type="button" data-selector="group_field_repeat" data-confirm="Are you sure you want to remove it?" class="cmb-remove-group-row cmb-remove-group-row-button alignright button-secondary">Remove Group</button>
								</div>
							</div>
						</div>
					</div>
